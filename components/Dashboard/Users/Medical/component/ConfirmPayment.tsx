...
const ConfirmPayment: React.FC<ConfirmPaymentProp> = ({onPaymentSuccessful}) =>{
  ...
  return (
    <div className="w-full sm:w-[300px] mx-auto bg-white rounded-xl  overflow-hidden md:max-w-2xl p-2  my-10">
      ...
      <button className="bg-[#0364FF] text-white p-2 sm:p-3 w-full rounded-xl font-semibold flex items-center justify-center gap-2 mt-8" onClick={onPaymentSuccessful}>
