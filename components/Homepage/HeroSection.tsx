...
<div className="w-full bg-[url('/m-hero-bg.png')] lg:bg-no-repeat lg:bg-top lg:bg-cover h-[600px] lg:h-[655px] z-50">
  ...
  <div className="px-4 lg:px-20 pt-10 lg:pt-20 flex items-center justify-center lg:justify-start">
    <div className="w-full sm:w-[500px]">
      ...
      <div className="flex items-center flex-wrap w-full gap-4 mt-8">
        <button className="w-full lg:w-[187px] rounded-3xl py-2 bg-[#10BEDA] text-center text-[16px] text-white font-medium">
          Get Appointment
        </button>
        <button className="w-full lg:w-[153px] rounded-3xl py-2 bg-transparent border border-[#003647] text-center text-[16px] text-[#003647] font-medium">
          Learn More
        </button>
      </div>
    </div>
