    ...
    <div className="px-4 lg:px-20  bg-white pt-10 pb-20">
      <div className="bg-white flex items-center justify-center xl:justify-between -mt-24 lg:-mt-40 xl:p-10 p-5  flex-wrap rounded-3xl shadow-xl ">
        ...
        <div className="w-full sm:w-[462px]">
          ...
          Healthcare for our Expatriates Patients in Ireland 
          </h1>
        ...
        <div className="flex items-center justify-center flex-wrap sm:mt-0 gap-4">
          {cardData.map((data, index) => (
            ...
            <div className="shrink w-[174px] h-auto ml-10">
              <div
                className={`w-auto h-[152px] flex items-center justify-center  rounded-3xl `}
              >
                <Image
                  src="/trustpilot_logo.png"
                  width={200}
                  height={72}
                  alt="BP images"
                />
              </div>
              <p className="text-md text-[#727272] font-normal text-center">
                35 Trustscore | 345 Reviews
              </p>
            </div>
        </div>
      </div>
